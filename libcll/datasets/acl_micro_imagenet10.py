...
class ACLMicro_ImageNet10(torchvision.datasets.CIFAR10, CLBaseDataset):
    """
    ...
    def __init__(
        ...
        if train:
            dataset_path = f"{root}/aclmicro_imagenet10_train.pkl"
            gid = "1mYCfykcbifm0WHdJzLCbuH4wiAloqL5Z"
        else:
